...
export default function HeroSection() {
  return (
    <div className="flex items-stretch gap-3 px-4 lg:px-6 py-4">
      {/* Category sidebar - desktop only */}
      <aside className="hidden lg:block w-48 shrink-0 bg-white border border-gray-200 rounded">
        <ul>
      ...
      {/* Hero banner */}
      <div className="flex-1 relative rounded overflow-hidden bg-teal-100 min-h-45 lg:min-h-60">
      ...
      <div className="hidden lg:flex flex-col gap-2 w-44 shrink-0">
        <div className="bg-white border border-gray-200 rounded p-3 flex flex-col gap-2">
          ...
          <button className="w-full border border-gray-300 text-gray-600 text-xs py-1.5 rounded hover:bg-gray-50">
            Log in
          </button>
        </div>
