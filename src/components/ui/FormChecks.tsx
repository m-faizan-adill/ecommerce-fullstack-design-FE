    ...
    return (
      ...
      >
        <span className="relative inline-flex items-center justify-center">
          ...
          <span
            className={cn(
              "h-4 w-4 rounded-sm border-2 border-[#BDBDBD] bg-[#FFFFFF] transition-colors duration-150",
    ...
    return (
      ...
      >
        <span className="relative inline-flex items-center justify-center">
          ...
          <span
            className={cn(
              "h-4 w-4 rounded-full border-2 border-gray-300 bg-[#FFFFFF] transition-colors duration-150",
  ...
  return (
    ...
    >
      <span className="relative inline-flex items-center">
        ...
        <span
          className={cn(
            "absolute left-0.5 h-4 w-4 rounded-full bg-[#FFFFFF] shadow transition-transform duration-200",
