...
export const products: Product[] = [
  ...
  { id: "P-1002", name: "GoPro HERO6 4K Action Camera", price: 499, image: "/assets/Image/tech/image 29.png", description: "4K action camera for adventures", category: "Cameras", stock: 12, rating: 2.5 },
  { id: "P-1003", name: "Wireless gaming headset", price: 89, image: "/assets/Image/tech/image 32.png", description: "High quality wireless gaming headset", category: "Audio", stock: 230, rating: 1.5 },
  { id: "P-1004", name: "Smartwatch Pro — silver", price: 199, image: "/assets/Image/tech/image 33.png", description: "Premium smartwatch in silver", category: "Wearables", stock: 0, rating: 4.5 },
  ...
  { id: "P-1006", name: "iPhone 15 Pro — 256GB", price: 1099, image: "/assets/Image/tech/image 85.png", description: "Latest iPhone with 256GB storage", category: "Smartphones", stock: 56, rating: 3 },
  { id: "P-1007", name: "Leather travel wallet", price: 34, image: "/assets/Image/tech/image 86.png", description: "Premium leather travel wallet", category: "Accessories", stock: 480, rating: 2 },
  { id: "P-1008", name: "Electric kettle 1.2L", price: 39, image: "/assets/Image/tech/6.png", description: "Fast boiling electric kettle", category: "Home", stock: 0, rating: 4.5 },
