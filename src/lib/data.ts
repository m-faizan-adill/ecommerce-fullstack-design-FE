...
export const products: Product[] = [
  ...
  { id: "P-1009", name: "T-shirts with multiple colors", price: 10.30, image: "/assets/Layout/alibaba/Image/cloth/2 1.png", description: "Cotton t-shirt for men", category: "Clothes", stock: 120 },
  { id: "P-1010", name: "Jeans shorts for men blue color", price: 10.30, image: "/assets/Layout/alibaba/Image/cloth/Bitmap.png", description: "Slim fit jeans shorts", category: "Clothes", stock: 80 },
  { id: "P-1011", name: "Brown winter coat medium size", price: 12.50, image: "/assets/Layout/alibaba/Image/cloth/Bitmap (2).png", description: "Warm winter coat", category: "Clothes", stock: 45 },
  { id: "P-1012", name: "Jeans bag for travel for men", price: 34.00, image: "/assets/Layout/alibaba/Image/cloth/image 24.png", description: "Durable travel bag", category: "Accessories", stock: 60 },
];
